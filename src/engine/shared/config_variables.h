...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "ttt", CFGFLAG_SERVER, "Game type (ddnet, mod)")
...
MACRO_CONFIG_STR(SvWaitingMap, sv_waiting_map, 128, "ttt_waiting", CFGFLAG_SERVER, "TTT waiting/pre-lobby map. If set, TTT starts rounds from this map")
...
MACRO_CONFIG_INT(SvOutlierBots, sv_outlier_bots, 18, 0, SERVER_MAX_CLIENTS, CFGFLAG_SERVER | CFGFLAG_GAME, "Outlier: number of fake bot clients to spawn (can be overridden by map settings)")
...
MACRO_CONFIG_STR(SvMap4, sv_map_4, 128, "", CFGFLAG_SERVER, "TTT map pool slot 4")
MACRO_CONFIG_STR(SvMap5, sv_map_5, 128, "", CFGFLAG_SERVER, "TTT map pool slot 5")
MACRO_CONFIG_STR(SvMap6, sv_map_6, 128, "", CFGFLAG_SERVER, "TTT map pool slot 6")
MACRO_CONFIG_STR(SvMap7, sv_map_7, 128, "", CFGFLAG_SERVER, "TTT map pool slot 7")
MACRO_CONFIG_STR(SvMap8, sv_map_8, 128, "", CFGFLAG_SERVER, "TTT map pool slot 8")
MACRO_CONFIG_STR(SvMap9, sv_map_9, 128, "", CFGFLAG_SERVER, "TTT map pool slot 9")
MACRO_CONFIG_STR(SvMap10, sv_map_10, 128, "", CFGFLAG_SERVER, "TTT map pool slot 10")
MACRO_CONFIG_STR(SvMap11, sv_map_11, 128, "", CFGFLAG_SERVER, "TTT map pool slot 11")
MACRO_CONFIG_STR(SvMap12, sv_map_12, 128, "", CFGFLAG_SERVER, "TTT map pool slot 12")
...
MACRO_CONFIG_INT(SvRandomClientSlots, sv_random_client_slots, 0, 0, 1, CFGFLAG_SERVER, "Randomly assign free client slots for new connections")
